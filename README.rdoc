...
The +master+ branch is bare application, +restafari_org+ branch is what will runs www.restafari.org.

You *should make your own branch* for your own styling, so you can <tt>git pull</tt> any future updates from the master and then merge them into your branch.
...
* Use Capistrano task <tt>cap upload_config</tt> to copy <tt>config.yml</tt> to server
