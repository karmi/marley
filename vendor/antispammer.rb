...
# Interface to the Typkey Antispam web service
# See http://antispam.typepad.com/info/developers.html
# 
# Designed after Akismetor from
...
class Antispammer
  ...
  def execute(command)
    http = Net::HTTP.new("#{attributes[:key]}.api.antispam.typepad.com", 80)
